...
app.add_exception_handler(urls_excs.ShortUriAlreadyExists, urls_excs.short_uri_already_exists_handler)
app.add_exception_handler(urls_excs.ShortUriDoesNotExist, urls_excs.short_uri_does_not_exist_handler)
